<?php
    ...
    $sum_nckh =  isset($nckh->nckh__Get_By_Id_Index_And_Id_Giang_Vien_Sum($id_index, $id_giang_vien)->sum_kq) ? $nckh->nckh__Get_By_Id_Index_And_Id_Giang_Vien_Sum($id_index, $id_giang_vien)->sum_kq : 0;
 
    $so_tiet = $sum_cvk + $sum_nckh; 
    $dongia__Get_Last  = $dongia->dongia__Get_Last();

    if(count($sumthanhtoan->sumthanhtoan__Get_By_Index_Giang_Vien($id_index, $id_giang_vien))< 1){
