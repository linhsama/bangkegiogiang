...
<div class="ml-0 mr-3 content-wrapper">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        <div class="card-tools">
                            <nav class="ml-0 main-header navbar navbar-expand navbar-white navbar-light">
                                <ul class="">
                                    <select required="id_index" onchange="location = this.value"
    ...
    <section class="content">
        <form class="row form" action="quan-ly-giang-day/action.php?req=add" method="post"
            ...
            <input type="hidden" required="id_index" class="form-control" value="<?=$id_index?>" />
            <input type="hidden" required="id_giang_vien" class="form-control" value="<?=$id_giang_vien?>" />
            <div class="col-12">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select required="id_nhom_giang_day" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required="ten_mon_hoc" class="form-control" value=""
                                placeholder="Nhập môn học" />
                        </div>
                        <div class="form-group">
                            <label for="">Tên lớp học</label>
                            <input type="text" required="ten_lop_hoc" class="form-control" placeholder="Nhập lớp học" />
                        </div>
                        <div class="form-group">
                            <label for="">Số sinh viên</label>
                            <input type="number" min="0" max="200" required="so_sinh_vien" class="form-control"
                                placeholder="Nhập số sinh viên" />
                        </div>
                        <div class="form-group">
                            <label for="">Số nhóm</label>
                            <input type="number" min="0" max="200" required="so_nhom" class="form-control"
                                placeholder="Nhập số nhóm" />
                        </div>
                        <div class="form-group">
                            <label for="">Số tiết môn học</label>
                            <input type="number" min="0" max="200" required="so_tiet_mon_hoc" class="form-control"
                                placeholder="Nhập số tiết môn học" />
                        </div>
                        <div class="form-group">
                            <label for="">Số tiết thực giảng</label>
                            <input type="number" min="0" max="200" required="so_tiet_thuc_giang" class="form-control"
                                placeholder="Nhập số tiết thực giảng" />
                        </div>
                        <div class="form-group">
                            <label for="">Hệ số nhóm</label>
                            <input type="number" min="0" max="200" required="he_so_nhom" class="form-control"
                                placeholder="Nhập hệ số nhóm" />
                        </div>
                        <div class="form-group">
                            <label for="">Hệ số tín chỉ</label>
                            <input type="number" min="0" max="200" required="he_so_tin_chi" class="form-control"
